...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/pages/addons/chat_system.vue?vue&type=script&lang=js&":
/*!****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/pages/addons/chat_system.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    ...
    setInterval(function () {
      if (!$('.title-right').hasClass('chatbox-hide') && _this.authUser) {
        _this.fetchUser(_this.selected_user);
      }
    }, 5000);
  },
  watch: {
  ...
  computed: {
    currentSellerId: function currentSellerId() {
      return this.$store.getters.getCurrentSellerId;
    }
  },
  methods: {
    dateConvert: function dateConvert(dateTime) {
    ...
    loadSellers: function loadSellers(isVisible) {
      if (!isVisible) {
        return true;
      }
    ...
    fetchUser: function fetchUser(seller, scroll) {
      var _this3 = this;
      if (this.authUser) {
        var config = {
          params: {
        ...
        var url = this.getUrl("home/chat-sellers");
        axios.get(url, config).then(function (response) {
          if (response.data.error) {
            toastr.error(response.data.error, _this3.lang.Error + " !!");
          } else {
            var sellers = response.data.sellers.data;
            _this3.last_page = response.data.sellers.last_page;
            if (!seller) {
              if (sellers.length > 0) {
                for (var i in sellers) {
                  _this3.sellers.data.push(sellers[i]);
                }
                _this3.selected_user = _this3.sellers.data[0];
              }
            } else {
              _this3.chat_active = true;
              _this3.sellers.data = sellers;
            }
            if (_this3.refresh_no == 1) {
              scroll = true;
            }
            _this3.refreshMessages(_this3.selected_user, scroll);
          }
        })["catch"](function (error) {
          toastr.error(error.response.data.message, _this3.lang.Error + " !!");
        });
      }
    },
    fetchMessages: function fetchMessages(seller, scroll) {
      var _this4 = this;
      var that = this;
      ...
      var url = that.getUrl("frontend/messages");
      axios.get(url, {
        params: params
        ...
        if (response.data.error) {
          ...
          var messages = response.data.user_messages.data.reverse();
          var _loop = function _loop() {
            var message = messages[i];
            var find = that.messages.find(function (m) {
    ...
    refreshMessages: function refreshMessages(seller, scroll) {
      var _this5 = this;
      var that = this;
      if (seller) {
        that.form.chat_room_id = seller.chat_room_id;
        ...
        axios.get(url, {
          ...
          if (response.data.error) {
            ...
            var messages = response.data.user_messages.data;
            for (var i = 0; i < messages.length; i++) {
    ...
    handleMsgSend: function handleMsgSend() {
    ...
    sendMessage: function sendMessage(file, index) {
      var _this6 = this;
      ...
      var chat_room = this.selected_user.chat_room_id;
      ...
      axios.post(this.getUrl('chat/send-message'), formData).then(function (response) {
        if (response.data.error) {
          toastr.error(response.data.error, _this6.lang.Error + " !!");
        } else {
          _this6.page = 1;
          _this6.refresh_no = 1;
          _this6.msg_page = _this6.msg_last_page + 1;
          if (!file) {
            _this6.form.msg = '';
          }
          if (index > -1) {
          ...
          _this6.selected_user.chat_room_id = response.data.chat_room_id;
          _this6.fetchUser(_this6.selected_user, 1);
        }
      })["catch"](function (error) {
        toastr.error(error.response.data.message, _this6.lang.Error + " !!");
      });
    },
    ...
    previewFile: function previewFile(event) {
      var inputted_files = event.target.files;
      for (var i = 0; i < inputted_files.length; i++) {
        var file = inputted_files[i];
    ...
    searchUser: function searchUser() {
      ...
      axios.get(url, config).then(function (response) {
        if (response.data.error) {
          ...
          var sellers = response.data.sellers.data;
          _this7.last_page = response.data.sellers.last_page;
          _this7.sellers.data = sellers;
        }
      })["catch"](function (error) {
        toastr.error(error.response.data.message, _this7.lang.Error + " !!");
      });
    }
  },
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _pages_addons_chat_system__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../pages/addons/chat_system */ "./resources/js/components/frontend/pages/addons/chat_system.vue");

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: "bottom",
  components: {
    chat_system: _pages_addons_chat_system__WEBPACK_IMPORTED_MODULE_0__["default"]
  },
  data: function data() {
    return {
      gdpr: true
  ...
  mounted: function mounted() {
    var scrollToTop = document.querySelector(".btnTOP");
...
/* harmony import */ var _partials_sidebar_categories__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../partials/sidebar_categories */ "./resources/js/components/frontend/partials/sidebar_categories.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    ...
    sidebar_categories: _partials_sidebar_categories__WEBPACK_IMPORTED_MODULE_3__["default"]
  },
  data: function data() {
    return {
      mobile_child_id: 0,
  ...
  methods: {
    ...
    changeLanguage: function changeLanguage(locale) {
      ...
      axios.get(url).then(function (response) {
        if (response.data.error) {
          toastr.info(response.data.error, _this.lang.Info + " !!");
        } else {
    ...
    changeCurrency: function changeCurrency(currency) {
      var _this2 = this;
      var url = this.getUrl("change/currency/" + currency.code);
      ...
      axios.get(url).then(function (response) {
        if (response.data.error) {
          ...
          _this2.$store.dispatch("activeCurrency", response.data.active_currency);
    ...
    currencyDropdown: function currencyDropdown() {
      ...
      this.currency_dropdown && this.$nextTick(function () {
        document.addEventListener("click", _this3.hideCurrencyDropdown);
      });
    },
    ...
    languageDropdown: function languageDropdown() {
      ...
      this.language_dropdown && this.$nextTick(function () {
        document.addEventListener("click", _this4.hideLanguageDropdown);
      });
    },
    ...
    searchDropdown: function searchDropdown() {
      ...
      this.search_key_focus && this.$nextTick(function () {
        document.addEventListener("click", _this5.hideSearchDropdown);
      });
    },
      ...
      if (confirm("Are you sure?")) {
        ...
        axios.get(url).then(function (response) {
          if (response.data.error) {
            ...
            _this6.$store.dispatch("carts", response.data.carts);
          }
        });
      }
    },
    searchProducts: function searchProducts() {
      ...
      axios.post(url, form).then(function (response) {
        if (response.data.error) {
          ...
          _this7.search_products = response.data.products;
        }
      })["catch"](function (error) {
        _this7.search_products = [];
      });
    },
    categoryMenu: function categoryMenu() {
      ...
      this.show_sm_category && this.$nextTick(function () {
        document.addEventListener("click", _this8.hideCategoryMenu);
      });
    },
    homeMenu: function homeMenu() {
      ...
      this.show_sm_home && this.$nextTick(function () {
        document.addEventListener("click", _this9.hideHomeMenu);
      });
    },
    ...
    checkoutPage: function checkoutPage(event) {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/pages/about.vue?vue&type=template&id=124ad160&scoped=true&":
/*!**************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/pages/about.vue?vue&type=template&id=124ad160&scoped=true& ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/pages/addons/chat_system.vue?vue&type=template&id=60394ae7&":
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/pages/addons/chat_system.vue?vue&type=template&id=60394ae7& ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c("div", {
    staticClass: "message-box chatbox-width"
  }, [_c("div", {
    staticClass: "message-title",
    on: {
      click: _vm.divToggler
    }
  }, [_c("div", {
  ...
  })]), _vm._v("\n        " + _vm._s(_vm.lang.Message) + "\n      ")])]), _vm._v(" "), _c("div", {
    staticClass: "title-right chatbox-hide"
  }, [_c("h2", [_vm._v(_vm._s(_vm.settings.system_name))])])]), _vm._v(" "), _c("div", {
    staticClass: "user-chatbox-show chatbox-hide"
  }, [_c("div", {
    staticClass: "user-chatbox"
  }, [_c("div", {
    staticClass: "user-chat-list"
  }, [_c("div", {
    staticClass: "user-list"
  }, [_vm.authUser && _vm.authUser.user_type == "customer" ? _c("ul", [_c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.search,
    ...
    staticClass: "user-search-field",
    attrs: {
      type: "text",
      name: "search_user",
      id: "search_user",
      placeholder: _vm.lang.search_user
    },
    domProps: {
      value: _vm.search
    },
  ...
  }), _vm._v(" "), _vm._l(_vm.sellers.data, function (seller, index) {
    return _c("li", {
      directives: [{
        name: "observe-visibility",
        rawName: "v-observe-visibility",
        value: index === _vm.sellers.data.length - 1 ? _vm.loadSellers : false,
        expression: "index === sellers.data.length - 1 ? loadSellers : false"
      }],
      key: index
    }, [_c("a", {
      "class": {
        active: _vm.selected_user.user_id == seller.user_id
      },
      attrs: {
      ...
      on: {
        click: function click($event) {
          return _vm.fetchMessages(seller, 1);
        }
      }
    }, [_c("div", {
    ...
    }, [_c("h4", [_vm._v(_vm._s(seller.shop_name))]), _vm._v(" "), seller.has_message ? _c("p", {
      staticClass: "text-overflow"
    }, [_vm._v(_vm._s(seller.message.message))]) : _vm._e()])])]);
  })], 2) : _vm._e()])]), _vm._v(" "), _c("div", {
    staticClass: "chatbox-form",
    attrs: {
      id: "chatbox-form"
    }
  }, [_c("div", {
    ...
    return _vm.messages.length > 0 && _vm.authUser && _vm.authUser.user_type == "customer" ? _c("div", {
      key: index
    }, [_c("p", {
      staticStyle: {
        "text-align": "center"
      }
    }, [_vm._v(_vm._s(_vm.dateConvert(message.created_at)))]), _vm._v(" "), _c("div", {
      staticClass: "message-sender",
      "class": {
        page_1: message.page == 1,
        user: message.type == 2
      }
    }, [message.is_file ? _c("div", {
      staticClass: "message-text"
    }, [message.is_image ? _c("a", {
      attrs: {
        href: message.file_url,
        title: message.message,
        download: ""
      }
    }, [message.file_exist ? _c("img", {
      attrs: {
      ...
      attrs: {
        src: _vm.getUrl("public/images/default/no_image.jpg"),
        alt: message.message
      }
    })]) : message.is_video ? _c("div", [message.file_exist ? _c("vue-plyr", [_c("video", [_c("source", {
      attrs: {
        src: message.file_url,
      ...
      attrs: {
        src: _vm.getUrl("images/default/default-video-72x72.png"),
        alt: "image"
      }
    })], 1) : _c("a", {
      attrs: {
      ...
      staticClass: "file-preview-title name_clip"
    }, [_vm._v("\n                  " + _vm._s(message.message) + "\n                ")]), _vm._v(" "), _c("span", {
      staticClass: "file-size"
    }, [_vm._v(_vm._s(message.file_size))]), _vm._v(" "), _c("div", {
      staticClass: "file-proview-icon"
    }, [_c("svg", {
      attrs: {
        xmlns: "http://www.w3.org/2000/svg",
        width: "16",
    ...
    })]), _vm._v(" "), _c("span", [_vm._v(_vm._s(_vm.lang.File))])])])]) : _c("div", {
      staticClass: "message-text"
    }, [_vm.urlCheck(message.message) ? _c("a", {
      attrs: {
        href: message.message,
        target: "_blank"
      }
    }, [_vm._v(_vm._s(message.message))]) : _c("p", [_vm._v(_vm._s(message.message))])]), _vm._v(" "), _c("div", {
      staticClass: "message-sender-img"
    }, [message.type == 1 ? _c("img", {
      attrs: {
      ...
      attrs: {
        src: _vm.selected_user.logo,
        alt: _vm.selected_user.user_name
      }
    })]), _vm._v(" "), message.is_file && !message.file_exist ? _c("span", {
      staticClass: "warning_mgs"
    }, [_vm._v(_vm._s(_vm.lang.file_not_exist) + ".")]) : _vm._e()])]) : _vm._e();
  }), _vm._v(" "), _vm.messages.length == 0 && _vm.authUser && _vm.authUser.user_type == "customer" ? _c("h6", {
    staticClass: "text-danger text-center mt-5 pt-5"
  }, [_vm._v(_vm._s(_vm.lang.no_data_found))]) : _vm._e(), _vm._v(" "), _vm.authUser && _vm.authUser.user_type == "admin" ? _c("h6", {
    staticClass: "text-danger text-center mt-5 pt-5"
  }, [_vm._v(_vm._s(_vm.lang.login_as_customer))]) : _vm._e(), _vm._v(" "), _vm.authUser && _vm.authUser.user_type == "seller" ? _c("h6", {
    staticClass: "text-danger text-center mt-5 pt-5"
  }, [_vm._v(_vm._s(_vm.lang.use_seller_panel))]) : _vm._e(), _vm._v(" "), !_vm.authUser ? _c("div", {
    staticClass: "h-100"
  }, [_c("div", {
    staticClass: "message-content-login"
  }, [_c("svg", {
    attrs: {
      width: "34",
      height: "26",
  ...
  })]), _vm._v(" "), _c("p", [_vm._v(_vm._s(_vm.lang.start_conversation_msg))]), _vm._v(" "), _c("ul", {
    staticClass: "d-flex"
  ...
  }, [_vm._v(_vm._s(_vm.lang.sign_in))]), _vm._v("/")], 1), _vm._v(" "), _c("li", [_c("router-link", {
    attrs: {
      to: {
        name: "register"
      }
    }
  }, [_vm._v(_vm._s(_vm.lang.register))])], 1)])])]) : _vm._e()], 2), _vm._v(" "), _vm.authUser && _vm.authUser.user_type == "customer" ? _c("div", {
    staticClass: "chat-form"
  }, [_c("div", {
    staticClass: "chat-preview-items"
  }, _vm._l(_vm.files, function (file, index) {
    return _c("div", {
      key: index,
      staticClass: "file_div"
    }, [_c("a", {
      ...
      attrs: {
        src: _vm.imagePreview(file),
        alt: "preview image",
        width: "50"
      }
    }), _vm._v(" "), file.type.split("/")[0] != "image" ? _c("span", {
      staticClass: "name_clip"
    }, [_vm._v(_vm._s(file.name))]) : _vm._e()])]);
  }), 0), _vm._v(" "), _c("form", {
    on: {
      submit: function submit($event) {
        $event.preventDefault();
        return _vm.handleMsgSend.apply(null, arguments);
      }
    }
  }, [_c("label", {
    ...
    attrs: {
      type: "text",
      placeholder: _vm.lang.type_message
    },
    domProps: {
      value: _vm.form.msg
    },
    ...
    attrs: {
      ...
      transform: "translate(-0.99 -1.571)",
      fill: "#999"
    }
  })])])])])]) : _vm._e()])])])]);
};
...
var render = function render() {
  ...
  return _c("footer", {
    ...
    attrs: {
      loading: "lazy",
      src: _vm.settings.footer_logo,
      alt: "preloader"
    }
  })])], 1), _vm._v(" "), _c("div", {
    staticClass: "row"
  }, [!_vm.addons.includes("ramdhani") && _vm.settings.seller_system == 1 && !_vm.authUser ? _c("div", {
    staticClass: "col-sm-6 col-md-6",
    "class": [_vm.classObj()]
  }, [!_vm.authUser && _vm.settings.seller_system == 1 ? _c("div", {
    staticClass: "footer-widget widget-border"
  ...
  }, [_vm._v(_vm._s(_vm.lang.signup_as_seller) + "\n\t\t\t\t\t\t\t\t\t")])], 1)])]) : _vm._e()]) : _vm._e(), _vm._v(" "), _c("div", {
    staticClass: "col-sm-6 col-md-6",
    "class": [_vm.classObj()]
  }, [_c("div", {
    staticClass: "footer-widget widget-border"
  ...
  }, [_vm._v(_vm._s(_vm.lang.change_password) + " ")])], 1), _vm._v(" "), _c("li", [_c("router-link", {
    attrs: {
      to: {
        name: "order.history"
      }
  ...
  }, [_vm._v(_vm._s(_vm.settings.footer_contact_phone))])])])])])]), _vm._v(" "), _c("div", {
    staticClass: "col-sm-12 col-md-12 col-lg-3"
  }, [_c("div", {
    staticClass: "footer-widget"
  }, [_c("h3", [_vm._v(_vm._s(_vm.lang.about))]), _vm._v(" "), _c("div", {
    domProps: {
    ...
    staticClass: "global-list"
  }, _vm._l(_vm.footerMenu, function (menu, i) {
    return _c("li", {
      key: i
    ...
    }, [_vm._v(_vm._s(menu.label))]) : _vm._e(), _vm._v(" "), _c("router-link", {
      attrs: {
        to: menu.url
      }
  ...
  }, [_c("p", [_vm._v(_vm._s(_vm.settings.copyright))])]), _vm._v(" "), _c("div", {
    ...
    attrs: {
      src: _vm.getUrl("public/images/payment-method/visa.svg"),
      alt: "visa_pay_banner"
    }
  })]) : _vm._e(), _vm._v(" "), _vm.settings.master_card_pay_banner ? _c("li", [_c("img", {
    staticClass: "img-fluid footer-payment-icon",
    attrs: {
      src: _vm.getUrl("public/images/payment-method/master-card.svg"),
      alt: "master_card_pay_banner"
    }
  })]) : _vm._e(), _vm._v(" "), _vm.settings.american_express_pay_banner ? _c("li", [_c("img", {
    staticClass: "img-fluid footer-payment-icon",
    attrs: {
      src: _vm.getUrl("public/images/payment-method/american-express.svg"),
      alt: "american_express_pay_banner"
    }
  })]) : _vm._e(), _vm._v(" "), _vm.settings.paypal_payment_banner ? _c("li", [_c("img", {
    staticClass: "img-fluid footer-payment-icon",
    attrs: {
      src: _vm.getUrl("public/images/payment-method/paypal.svg"),
      alt: "paypal_payment_banner"
    }
  })]) : _vm._e(), _vm._v(" "), _vm.settings.apple_pay_banner ? _c("li", [_c("img", {
    staticClass: "img-fluid footer-payment-icon",
    attrs: {
      src: _vm.getUrl("public/images/payment-method/apple-pay.svg"),
      alt: "apple_pay_banner"
    }
  })]) : _vm._e(), _vm._v(" "), _vm.settings.amazon_pay_banner ? _c("li", [_c("img", {
    staticClass: "img-fluid footer-payment-icon",
    attrs: {
      src: _vm.getUrl("public/images/payment-method/amazon-pay.svg"),
      alt: "amazon_pay_banner"
    }
  })]) : _vm._e(), _vm._v(" "), _vm.settings.after_pay_banner ? _c("li", [_c("img", {
    staticClass: "img-fluid footer-payment-icon",
    attrs: {
      src: _vm.getUrl("public/images/payment-method/after-pay.svg"),
      alt: "after_pay_banner"
    }
  })]) : _vm._e(), _vm._v(" "), _vm.settings.payment_method_banner ? _c("li", {
    staticClass: "full-payment-img"
  }, [_c("img", {
    staticClass: "img-fluid footer-payment-icon",
    attrs: {
      src: _vm.settings.payment_method_banner,
      alt: "payment_method_banner"
    }
  })]) : _vm._e()])])])])]), _vm._v(" "), _c("div", {
    staticClass: "mb-bottom"
  }), _vm._v(" "), _vm.checkGDPR() && _vm.gdpr ? _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.lang.accept_all))])])]) : _vm._e(), _vm._v(" "), _vm._m(0), _vm._v(" "), _vm.addons.includes("chat_system") ? _c("chat_system") : _vm._e()], 1);
};
var staticRenderFns = [function () {
  ...
  return _c("div", {
    ...
    staticClass: "icon mdi mdi-name mdi-chevron-up"
  })]);
}];
render._withStripped = true;
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/partials/header.vue?vue&type=template&id=2f34b210&scoped=true&":
/*!******************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/partials/header.vue?vue&type=template&id=2f34b210&scoped=true& ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("header", {
    ...
    "class": _vm.addons.includes("ishopet") ? _vm.toggleNavClass() : "",
    attrs: {
      id: "middle_nav"
    }
  }, [_c("div", {
    ...
    staticClass: "sg-categorie-menu categorie-lg align-self-lg-center"
  }, [_vm.addons.includes("ishopet") ? _c("div", {
    staticClass: "top-content"
  }, [_c("button", {
    staticClass: "sg-toggle",
    on: {
      click: _vm.toggleCategory
    }
  }, [_c("svg", {
    attrs: {
      xmlns: "http://www.w3.org/2000/svg",
  ...
  })])])])]) : _vm._e(), _vm._v(" "), _vm.addons.includes("ishopet") ? _c("sidebar_categories", {
    ...
    staticClass: "img-fluid",
    attrs: {
      src: _vm.getUrl("public/images/others/search.svg"),
      alt: "Product Search"
    }
  })]), _vm._v(" "), _vm.search_products.length > 0 && _vm.search_key_focus ? _c("ul", {
  ...
  }, _vm._l(_vm.search_products, function (product, index) {
    return _c("li", {
      key: index,
  ...
  }, [_vm._v(_vm._s(_vm.activeLanguage.name) + " ")]), _vm._v(" "), _c("ul", {
  ...
  }), 0)])]) : _vm._e(), _vm._v(" "), _c("li", [_vm.authUser && _vm.authUser.user_type == "customer" ? _c("router-link", {
    attrs: {
      to: {
        name: "wishlist"
      }
    ...
    attrs: {
      alt: "Compare Icon",
      src: _vm.getUrl("public/images/others/wishlist.svg")
    }
  })]), _vm._v(" "), _vm.wishlists > 0 ? _c("span", {
    staticClass: "badge"
  }, [_vm._v(_vm._s(_vm.wishlists))]) : _vm._e()]) : _c("a", {
    attrs: {
      href: "javascript:void(0)"
    }
  }, [_c("div", {
    ...
    staticClass: "badge"
  }, [_vm._v(_vm._s(_vm.wishlists))]) : _vm._e()])], 1), _vm._v(" "), _c("li", {
    ...
    attrs: {
      alt: "bag Icon",
      src: _vm.getUrl("public/images/others/bag.svg")
    }
  }), _vm._v(" "), _vm.carts && _vm.carts.length > 0 ? _c("span", {
    staticClass: "badge"
  }, [_vm._v(_vm._s(_vm.carts.filter(function (cart) {
    return cart.is_buy_now == false;
  }).length))]) : _vm._e()])]), _vm._v(" "), _vm.carts && _vm.carts.length > 0 ? _c("div", {
    ...
    }, [_vm._v("\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t" + _vm._s(cart.product_name) + "\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t")])], 1), _vm._v(" "), cart.variant ? _c("span", [_vm._v(_vm._s(_vm.lang.Variant) + " : " + _vm._s(cart.variant))]) : _vm._e(), _vm._v(" "), _c("span", {
      staticClass: "price"
    }, [_vm._v(_vm._s(_vm.priceFormat(cart.price - cart.discount)) + " x " + _vm._s(cart.quantity))])])]) : _vm._e()]);
  }), _vm._v(" "), _c("li", [_c("div", {
    ...
    staticClass: "btn btn-primary",
    attrs: {
      href: _vm.getUrl("checkout")
    },
    on: {
      click: function click($event) {
        return _vm.checkoutPage($event);
      }
    }
  }, [_vm._v(_vm._s(_vm.lang.check_out))])], 1)])], 2)]) : _vm._e()], 1), _vm._v(" "), _c("li", {
    ...
    attrs: {
      src: _vm.getUrl("public/images/others/compare.svg"),
      alt: "List"
    }
  })]), _vm._v(" "), _vm.compareList > 0 ? _c("span", {
    staticClass: "badge"
  }, [_vm._v(_vm._s(_vm.compareList))]) : _vm._e()])], 1), _vm._v(" "), _vm.authUser && (_vm.authUser.user_type == "admin" || _vm.authUser.user_type == "staff") ? _c("li", {
    staticClass: "d-flex user-log-info"
  }, [_c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.lang.dashboard))]), _vm._v(" "), _c("a", {
    attrs: {
      href: "javascript:void(0)"
    },
    on: {
  ...
  }, [_vm._v(" " + _vm._s(_vm.lang.logout))])])]) : _vm._e()])])])])]), _vm._v(" "), !_vm.addons.includes("ishopet") ? _c("div", {
  ...
  })])])]), _vm._v(" "), _c("span", [_vm._v(_vm._s(_vm.lang.all_categories))])]), _vm._v(" "), _c("sidebar_categories", {
    ref: "sidebar_category",
    attrs: {
      home: 1
    }
  ...
  })]), _vm._v("\n\n\t\t\t\t\t\t\t\t\t" + _vm._s(_vm.lang.daily_deals))])])], 1)])])])]) : _vm._e(), _vm._v(" "), _c("div", {
    staticClass: "sg-categorie-menu home-menu-sm"
  }, [_c("div", {
    staticClass: "sg-toggle",
    on: {
      click: function click($event) {
        return _vm.$store.commit("setSmCategory", false);
      }
    }
  }, [_c("span", {
  ...
  }), _vm._v(_vm._s(_vm.lang.all_offers) + " ")])], 1), _vm._v(" "), _vm._l(_vm.visibleCategory, function (category, index) {
    return _c("li", {
      key: index,
      staticClass: "active",
    ...
    }, [_vm._v(_vm._s(category.title))])]), _vm._v(" "), category.child_categories.length > 0 ? _c("ul", {
      staticClass: "sg-dropdown-menu",
      "class": {
      ...
      return _c("li", {
      ...
      }, [_vm._v(_vm._s(child_category.title))])]), _vm._v(" "), child_category.categories.length > 0 ? _c("ul", {
        staticClass: "sg-dropdown-menu",
        "class": {
        ...
        }, [_vm._v(_vm._s(children_category.title))])])], 1);
  ...
  }, [_vm._v(" " + _vm._s(_vm.lang.view_all_categories) + " "), _c("span", {
    ...
    attrs: {
      src: _vm.getUrl("public/images/others/list.svg"),
      alt: "menu"
    }
    ...
    attrs: {
      src: _vm.getUrl("public/images/others/home.svg"),
      alt: "Home"
    }
  })])], 1), _vm._v(" "), _c("li", [_c("a", {
    staticClass: "sg-toggle",
    ...
    attrs: {
      src: _vm.getUrl("public/images/others/menu.svg"),
      alt: "List"
    }
  })])]), _vm._v(" "), _c("li", [_c("router-link", {
    ...
    attrs: {
      src: _vm.getUrl("public/images/others/shopping-bag.svg"),
      alt: "shopping-bag"
    }
  })])], 1)])])])]), _vm._v(" "), _c("div", {
  ...
  }, [_vm._m(0), _vm._v(" "), _vm.productDetails ? _c("div", {
...
/***/ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/pages/about.vue?vue&type=style&index=0&id=124ad160&scoped=true&lang=css&":
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/pages/about.vue?vue&type=style&index=0&id=124ad160&scoped=true&lang=css& ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.sg-page-content[data-v-124ad160] {\r\n  background-color: #f9f9f9;\r\n  padding: 20px 0;\n}\n.about-section[data-v-124ad160] {\r\n  padding: 60px 0;\n}\n.page-title[data-v-124ad160] {\r\n  margin-bottom: 30px;\n}\n.page-title h1[data-v-124ad160] {\r\n  font-size: 2.5em;\r\n  color: #333;\r\n  text-align: center;\n}\n.about-content[data-v-124ad160] {\r\n  display: flex;\r\n  flex-wrap: wrap;\r\n  justify-content: space-between;\r\n  align-items: center;\n}\n.about-text[data-v-124ad160] {\r\n  flex: 1 1 50%;\r\n  padding: 20px;\r\n  font-size: 1.1em;\r\n  color: #555;\n}\n.about-image[data-v-124ad160] {\r\n  flex: 1 1 40%;\r\n  padding: 20px;\r\n  text-align: center;\n}\n.about-image img[data-v-124ad160] {\r\n  max-width: 100%;\r\n  height: auto;\r\n  border-radius: 10px;\r\n  box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);\n}\r\n", ""]);
// Exports
...
/***/ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/partials/header.vue?vue&type=style&index=0&id=2f34b210&scoped=true&lang=css&":
/*!****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/partials/header.vue?vue&type=style&index=0&id=2f34b210&scoped=true&lang=css& ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
var ___CSS_LOADER_EXPORT___ = _node_modules_laravel_mix_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.user-option .dropdown button[data-v-2f34b210] {\r\n\tborder: 0;\r\n\tbackground-color: transparent;\r\n\tfont-size: 13px;\r\n\tcolor: var(--theme-color);\n}\n.user-option .dropdown-menu[data-v-2f34b210] {\r\n\tmin-width: 110px;\r\n\tdisplay: none;\n}\n.user-option .dropdown-menu li[data-v-2f34b210] {\r\n\tmargin-right: 0;\r\n\tmargin-inline-end: 28px !important;\n}\n.user-option .dropdown-menu li img[data-v-2f34b210] {\r\n\tmargin-right: 8px;\n}\n.user-option .dropdown-menu li a[data-v-2f34b210] {\r\n\tdisplay: block;\r\n\tfont-size: 12px;\n}\n.user-option ul li[data-v-2f34b210] {\r\n\tmargin-inline-end: 13.2px;\r\n\tdisplay: flex;\r\n\tfont-size: 13px;\n}\n.user-option ul li a[data-v-2f34b210] {\r\n\talign-self: center;\r\n\tfont-size: 13px;\n}\r\n\r\n", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_about_vue_vue_type_style_index_0_id_124ad160_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./about.vue?vue&type=style&index=0&id=124ad160&scoped=true&lang=css& */ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/pages/about.vue?vue&type=style&index=0&id=124ad160&scoped=true&lang=css&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_about_vue_vue_type_style_index_0_id_124ad160_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_header_vue_vue_type_style_index_0_id_2f34b210_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./header.vue?vue&type=style&index=0&id=2f34b210&scoped=true&lang=css& */ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/partials/header.vue?vue&type=style&index=0&id=2f34b210&scoped=true&lang=css&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_header_vue_vue_type_style_index_0_id_2f34b210_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _about_vue_vue_type_template_id_124ad160_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./about.vue?vue&type=template&id=124ad160&scoped=true& */ "./resources/js/components/frontend/pages/about.vue?vue&type=template&id=124ad160&scoped=true&");
...
/* harmony import */ var _about_vue_vue_type_style_index_0_id_124ad160_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./about.vue?vue&type=style&index=0&id=124ad160&scoped=true&lang=css& */ "./resources/js/components/frontend/pages/about.vue?vue&type=style&index=0&id=124ad160&scoped=true&lang=css&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _about_vue_vue_type_template_id_124ad160_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render,
  _about_vue_vue_type_template_id_124ad160_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "124ad160",
  null
...
/***/ "./resources/js/components/frontend/pages/addons/chat_system.vue":
/*!***********************************************************************!*\
  !*** ./resources/js/components/frontend/pages/addons/chat_system.vue ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _chat_system_vue_vue_type_template_id_60394ae7___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chat_system.vue?vue&type=template&id=60394ae7& */ "./resources/js/components/frontend/pages/addons/chat_system.vue?vue&type=template&id=60394ae7&");
/* harmony import */ var _chat_system_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chat_system.vue?vue&type=script&lang=js& */ "./resources/js/components/frontend/pages/addons/chat_system.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _chat_system_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _chat_system_vue_vue_type_template_id_60394ae7___WEBPACK_IMPORTED_MODULE_0__.render,
  _chat_system_vue_vue_type_template_id_60394ae7___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/frontend/pages/addons/chat_system.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _header_vue_vue_type_template_id_2f34b210_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./header.vue?vue&type=template&id=2f34b210&scoped=true& */ "./resources/js/components/frontend/partials/header.vue?vue&type=template&id=2f34b210&scoped=true&");
...
/* harmony import */ var _header_vue_vue_type_style_index_0_id_2f34b210_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./header.vue?vue&type=style&index=0&id=2f34b210&scoped=true&lang=css& */ "./resources/js/components/frontend/partials/header.vue?vue&type=style&index=0&id=2f34b210&scoped=true&lang=css&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _header_vue_vue_type_template_id_2f34b210_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render,
  _header_vue_vue_type_template_id_2f34b210_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "2f34b210",
  null
...
/***/ "./resources/js/components/frontend/pages/addons/chat_system.vue?vue&type=script&lang=js&":
/*!************************************************************************************************!*\
  !*** ./resources/js/components/frontend/pages/addons/chat_system.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_chat_system_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./chat_system.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/pages/addons/chat_system.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_chat_system_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_master_vue_vue_type_template_id_1802dbf8___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_master_vue_vue_type_template_id_1802dbf8___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_master_vue_vue_type_template_id_1802dbf8___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./master.vue?vue&type=template&id=1802dbf8& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/master.vue?vue&type=template&id=1802dbf8&");


/***/ }),

/***/ "./resources/js/components/frontend/pages/about.vue?vue&type=template&id=124ad160&scoped=true&":
/*!*****************************************************************************************************!*\
  !*** ./resources/js/components/frontend/pages/about.vue?vue&type=template&id=124ad160&scoped=true& ***!
  \*****************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_about_vue_vue_type_template_id_124ad160_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_about_vue_vue_type_template_id_124ad160_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_about_vue_vue_type_template_id_124ad160_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./about.vue?vue&type=template&id=124ad160&scoped=true& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/pages/about.vue?vue&type=template&id=124ad160&scoped=true&");


/***/ }),

/***/ "./resources/js/components/frontend/pages/addons/chat_system.vue?vue&type=template&id=60394ae7&":
/*!******************************************************************************************************!*\
  !*** ./resources/js/components/frontend/pages/addons/chat_system.vue?vue&type=template&id=60394ae7& ***!
  \******************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_chat_system_vue_vue_type_template_id_60394ae7___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_chat_system_vue_vue_type_template_id_60394ae7___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_chat_system_vue_vue_type_template_id_60394ae7___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./chat_system.vue?vue&type=template&id=60394ae7& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/pages/addons/chat_system.vue?vue&type=template&id=60394ae7&");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_bottom_vue_vue_type_template_id_0e3d5f96___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_bottom_vue_vue_type_template_id_0e3d5f96___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_bottom_vue_vue_type_template_id_0e3d5f96___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./bottom.vue?vue&type=template&id=0e3d5f96& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/partials/bottom.vue?vue&type=template&id=0e3d5f96&");
...
/***/ "./resources/js/components/frontend/partials/header.vue?vue&type=template&id=2f34b210&scoped=true&":
/*!*********************************************************************************************************!*\
  !*** ./resources/js/components/frontend/partials/header.vue?vue&type=template&id=2f34b210&scoped=true& ***!
  \*********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_header_vue_vue_type_template_id_2f34b210_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_header_vue_vue_type_template_id_2f34b210_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_header_vue_vue_type_template_id_2f34b210_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./header.vue?vue&type=template&id=2f34b210&scoped=true& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/partials/header.vue?vue&type=template&id=2f34b210&scoped=true&");
...
/***/ "./resources/js/components/frontend/pages/about.vue?vue&type=style&index=0&id=124ad160&scoped=true&lang=css&":
/*!*******************************************************************************************************************!*\
  !*** ./resources/js/components/frontend/pages/about.vue?vue&type=style&index=0&id=124ad160&scoped=true&lang=css& ***!
  \*******************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_about_vue_vue_type_style_index_0_id_124ad160_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/style-loader/dist/cjs.js!../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./about.vue?vue&type=style&index=0&id=124ad160&scoped=true&lang=css& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/pages/about.vue?vue&type=style&index=0&id=124ad160&scoped=true&lang=css&");


/***/ }),

/***/ "./resources/js/components/frontend/partials/header.vue?vue&type=style&index=0&id=2f34b210&scoped=true&lang=css&":
/*!***********************************************************************************************************************!*\
  !*** ./resources/js/components/frontend/partials/header.vue?vue&type=style&index=0&id=2f34b210&scoped=true&lang=css& ***!
  \***********************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_header_vue_vue_type_style_index_0_id_2f34b210_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/style-loader/dist/cjs.js!../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./header.vue?vue&type=style&index=0&id=2f34b210&scoped=true&lang=css& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/partials/header.vue?vue&type=style&index=0&id=2f34b210&scoped=true&lang=css&");
