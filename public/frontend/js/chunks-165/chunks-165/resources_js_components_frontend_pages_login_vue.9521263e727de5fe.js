...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/pages/login.vue?vue&type=script&lang=js&":
/*!***************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/pages/login.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  methods: {
    login: function login(direct_login) {
      ...
      axiosWithCredentials.post(url, form).then(function (response) {
        ...
        if (response.data.success) {
          window.captcha = '';
          _this.errors = [];
          if (_this.optionTo == 'email' && !_this.otp_field && direct_login != 'direct_login' && !_this.settings.disable_otp) {
    ...
    socialLogin: function socialLogin(form) {
      ...
      axios.post(url, form).then(function (response) {
        ...
        _this2.social_login_active = false;
        if (response.data.success) {
          _this2.errors = [];
          if (_this2.loginRedirect) {
            _this2.$router.push({
              name: _this2.loginRedirect
            });
          } else {
            _this2.$router.push({
              name: 'dashboard'
        ...
        _this2.loading = false;
        _this2.social_login_active = false;
        toastr.error('Something Went Wrong, Please Try Again', _this2.lang.Error + ' !!');
      });
    },
    ...
    langKeywords: function langKeywords() {
      var _this4 = this;
      var url = this.getUrl('language/keywords');
      axios.get(url).then(function (response) {
        if (response.data.error) {
          toastr.info(response.data.error, _this4.lang.Info + ' !!');
        } else {
          _this4.$store.commit('setLangKeywords', response.data.lang);
          var language = response.data.language;
          if (language.text_direction == 'rtl') {
            document.body.setAttribute('dir', 'rtl');
            _this4.settings.text_direction = 'rtl';
          }
        }
      });
    }
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/pages/login.vue?vue&type=template&id=3f8bd5a8&":
/*!**************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/pages/login.vue?vue&type=template&id=3f8bd5a8& ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    attrs: {
      loading: "lazy",
      src: _vm.settings.login_banner,
      alt: "login_banner"
    }
  })]), _vm._v(" "), _vm.social_login_active ? _c("div", {
    staticClass: "form-content"
  }, [_c("loading_button", {
    attrs: {
      class_name: "social_loading"
    }
  })], 1) : _c("div", {
    staticClass: "form-content"
  }, [_c("h1", [_vm._v(_vm._s(_vm.lang.sign_in))]), _vm._v(" "), _c("p", [_vm._v(_vm._s(_vm.lang.sign_continue_shopping))]), _vm._v(" "), _c("form", {
  ...
  }, [_vm._v(_vm._s(_vm.errors.email[0]))]) : _vm._e(), _vm._v(" "), _vm.optionTo == "email" ? _c("div", [_c("telePhone", {
    attrs: {
  ...
  })], 1) : _vm._e(), _vm._v(" "), _vm.errors.phone ? _c("span", {
    staticClass: "validation_error"
  }, [_vm._v(_vm._s(_vm.errors.phone[0]))]) : _vm._e(), _vm._v(" "), _vm.addons.includes("otp_system") && !_vm.otp_field ? _c("div", {
    staticClass: "form-group mb-3 text-end"
  }, [_c("a", {
  ...
  }, [_vm._v(_vm._s(_vm.optionTo == "email" ? _vm.lang.use_email_instead : _vm.lang.use_phone_instead))])]) : _vm._e(), _vm._v(" "), _vm.otp_field ? _c("div", {
  ...
  })]) : _vm._e(), _vm._v(" "), _vm.optionTo == "phone" ? _c("div", {
    staticClass: "form-group",
    "class": {
    ...
    domProps: {
      checked: Array.isArray(_vm.form.remember) ? _vm._i(_vm.form.remember, "1") > -1 : _vm.form.remember
    },
    on: {
  ...
  }, [_vm._v(_vm._s(_vm.lang.remember_me))])]), _vm._v(" "), _c("router-link", {
    attrs: {
      to: {
        name: "reset.password"
      }
  ...
  }, [_vm._v(_vm._s(_vm.lang.forgot_your_password))])])], 1) : _vm._e(), _vm._v(" "), _vm.settings.is_recaptcha_activated == 1 ? _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.buttonText))]), _vm._v(" "), _vm.settings.demo_mode && !_vm.loading ? _c("div", {
  ...
  }, [_vm._v("Admin\n              ")]), _vm._v(" "), _vm.settings.seller_system == 1 ? _c("button", {
    staticClass: "btn copy_btn",
    attrs: {
      type: "button",
      href: "javascript:void(0)"
    ...
    on: {
      click: function click($event) {
        return _vm.copyLoginInfo("seller@spagreen.net");
      }
    }
    ...
    on: {
      click: function click($event) {
        return _vm.copyLoginInfo("customer@spagreen.net");
      }
    }
  }, [_vm._v("Customer\n              ")]), _vm._v(" "), _c("button", {
    staticClass: "btn copy_btn",
  ...
  }, [_vm._v("Staff\n              ")])]) : _vm._e(), _vm._v(" "), _c("p", [_vm._v(_vm._s(_vm.lang.don_have_an_account) + "\n              "), _c("router-link", {
    attrs: {
      to: {
        name: "register"
      }
    }
  }, [_vm._v(_vm._s(_vm.lang.sign_up))])], 1), _vm._v(" "), _vm.settings.is_facebook_login_activated == 1 || _vm.settings.is_google_login_activated == 1 || _vm.settings.is_twitter_login_activated == 1 ? _c("div", {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_login_vue_vue_type_template_id_3f8bd5a8___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_login_vue_vue_type_template_id_3f8bd5a8___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_login_vue_vue_type_template_id_3f8bd5a8___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./login.vue?vue&type=template&id=3f8bd5a8& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/pages/login.vue?vue&type=template&id=3f8bd5a8&");
