    ...
    langKeywords: function langKeywords() {
      ...
      axios.get(url).then(function (response) {
        if (response.data.error) {
          ...
          _this2.$store.commit('setLangKeywords', response.data.lang);
          var language = response.data.language;
          if (language.text_direction == 'rtl') {
            document.body.setAttribute('dir', 'rtl');
            _this2.settings.text_direction = 'rtl';
          }
        }
      });
    }
...
var render = function render() {
  ...
  }, [_c("h1", [_vm._v(_vm._s(_vm.lang.sign_in))]), _vm._v(" "), _c("form", {
  ...
  }, [_c("div", [_c("p", [_vm._v(_vm._s(_vm.lang.enter_phone_no))]), _vm._v(" "), _c("telePhone", {
    attrs: {
  ...
  })], 1), _vm._v(" "), _vm.errors.phone ? _c("span", {
  ...
  }, [_vm._v(_vm._s(_vm.lang.forgot_your_password))])])], 1) : _vm._e(), _vm._v(" "), _vm.loading ? _c("loading_button", {
    attrs: {
      class_name: "btn"
    }
  }) : _c("button", {
  ...
  }, [_vm._v(_vm._s(_vm.buttonText))]), _vm._v(" "), _c("p", [_vm._v(_vm._s(_vm.lang.don_have_an_account) + "\n              "), _c("router-link", {
    attrs: {
      to: {
        name: "register"
      }
    }
  }, [_vm._v(_vm._s(_vm.lang.sign_up))])], 1)], 1)])])])])]);
};
var staticRenderFns = [];
