    ...
    Route::group(
        ...
        Route::middleware(['adminCheck','loginCheck'])->group(function () {
            ...
            Route::prefix('admin')->group(function () {
                ...
                Route::put('category-featured-change', [CategoryController::class, 'featureChange'])->name('admin.category.feature.change')->middleware('PermissionCheck:category_update');
