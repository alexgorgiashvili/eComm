export default {
    ...
    getShopFollwer(state){
        return state.shop_follwer
    },
    getLoginRedirection(state)
    {
    ...
    getLangKeywords(state)
    {
        return state.lang_keywords;
    },
    getShopContents(state)
    {
        return state.shop_contents;
    },
    getShopComponent(state)
    {
